# ANA505 Week 5 R: Piping
a repository to hold my week 5 R activity code - Topic: piping
...
write.csv(mysample, '/Users/sereivadhanasong/Documents/McDaniel/Academics/Summer 2023/ANA-505 Data Mining/Week 5/my_sample.csv')
...
#Revised code from above using piping
mysample2<-mysample %>%
  arrange(airline) %>%
